                ...
                VStack {
                    ...
                    ZStack {
                        RoundedRectangle(cornerRadius: 20)
                            .frame(width: proxy.size.width - 100, height: (proxy.size.width - 100) * 1.3)
                            .background(.clear)
                            .overlay(
                                    RoundedRectangle(cornerRadius: 20)
                        ...
                        KFImage(URL(string: exercise.imageUrl ?? ""))
                                   .placeholder {
                                       Image("boardImage")
                                           .resizable()
                                           .scaledToFill()
